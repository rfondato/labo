...
hs <- makeParamSet( 
  ...
  makeIntegerParam("scale_pos_weight ",    lower=  1L , upper=    100L)
)
...
dir.create( "./exp/lightGBM_FE_4/", showWarnings = FALSE )
setwd("./exp/lightGBM_FE_4/")   #Establezco el Working Directory DEL EXPERIMENTO


#en estos archivos quedan los resultados
kbayesiana  <- "lightGBM_FE_4.RDATA"
klog        <- "lightGBM_FE_4.txt"
