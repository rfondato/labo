...
ksemilla_azar  <- 625643   #cambiar por la primer semilla
...
setwd("C:\\data_mining\\labo\\exp\\HT3320\\")   #Establezco el Working Directory DEL EXPERIMENTO


archivo_log  <- "332_con_mejores_HP.txt"
