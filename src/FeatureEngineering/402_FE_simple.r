...
EnriquecerDataset  <- function( dataset , arch_destino )
{
  ...
  dataset[ cliente_antiguedad== 3 , ctrx_quarter_normalizado := ctrx_quarter * 1 ]
...
setwd("C:\\data_mining\\labo\\exp\\FE4020\\")   #Establezco el Working Directory DEL EXPERIMENTO
