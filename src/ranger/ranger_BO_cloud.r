...
hs  <- makeParamSet(
          makeIntegerParam("num.trees" ,        lower=  3800L, upper= 4000L),  #la letra L al final significa ENTERO
...
ksemilla_azar  <- 625643  #Aqui poner la propia semilla
...
setwd("~/buckets/b1/labo/exp/HT4330/")   #Establezco el Working Directory DEL EXPERIMENTO
