...
ksemilla  <- 999983  #poner aqui la PRIMERA de sus cinco semillas
...
modelo  <- lgb.train( data= dtrain,
                      param= list( objective=        "binary",
                                   max_bin=              31,
                                   learning_rate=       0.02030451,
                                   num_iterations=      352,
                                   num_leaves=          584,
                                   min_data_in_leaf=   2077,
                                   feature_fraction=      0.2869717,
...
dir.create( "./labo/exp/lightGBM_FE_4/", showWarnings = FALSE )
setwd( "./labo/exp/lightGBM_FE_4/" )

archivo_salida  <- "lightGBM_FE_4.csv"
...
archivo_importancia  <- "lightGBM_FE_4_importancia.txt"
